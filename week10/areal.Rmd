...
or in matrix form $e = Be+\epsilon \rightarrow e=(1-B)^{-1}\epsilon$, which essentially is a moving average process. 
This leads to $$e_1, e_2, \ldots, e_n \sim N(0, (I-B)^{-1}D((I-B)^{-1})^T) $$
...
# Spatial conditional and simultaneous autoregression, SAR will be used as default
